...
pdf(paste0('/home/ahopkins/Documents/emj/ImmunoseqResults/R/plots/age-vs-overlap.pdf'),height=6,width=6)
plot(dict[-c(1,2),'age'],stats$overlap,
  xlab='Age at Diagnosis',
  ylab='Overlap')
dev.off()

pdf(paste0('/home/ahopkins/Documents/emj/ImmunoseqResults/R/plots/count-vs-overlap.pdf'),height=6,width=6)
plot(dict[-c(1,2),'cells'],stats$overlap,
  xlab='Input Cell Number',
  ylab='Overlap')
dev.off()

pdf(paste0('/home/ahopkins/Documents/emj/ImmunoseqResults/R/plots/clonality-vs-overlap.pdf'),height=6,width=6)
plot(stats$Clonality,stats$overlap,
  xlab='Clonality',
  ylab='Overlap')
dev.off()

pdf(paste0('/home/ahopkins/Documents/emj/ImmunoseqResults/R/plots/richness-vs-overlap.pdf'),height=6,width=6)
