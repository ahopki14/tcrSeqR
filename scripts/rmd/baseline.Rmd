...
dict <- readRDS('~/Documents/emj/ImmunoseqResults/data/baseline/dict.Rds')
stats <- readRDS('~/Documents/emj/ImmunoseqResults/data/baseline/stats.Rds')
load('~/Documents/emj/ImmunoseqResults/data/baseline/olm.Rda')
load('~/Documents/emj/ImmunoseqResults/data/baseline/sum.ds.Rda')
```
