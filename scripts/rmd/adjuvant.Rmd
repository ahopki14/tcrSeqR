...
```
```{r eval=first_run}
#ds <- readRDS('~/Documents/emj/ImmunoseqResults/mega/ds_agg_Adjuvant.Rds')
load('~/Documents/emj/ImmunoseqResults/mega/sum.ds_adjuvant.Rda')
dict <- readRDS('~/Documents/emj/ImmunoseqResults/mega/dict_Adjuvant.Rds')
stats <- readRDS('~/Documents/emj/ImmunoseqResults/mega/stats_Adjuvant.Rds')
load('~/Documents/emj/ImmunoseqResults/mega/olm_Adjuvant.Rda')
```
## Background
...
#rm(ds)
#ds_nt <- readRDS('~/Documents/emj/ImmunoseqResults/mega/fixed/ds_Adjuvant_fixed.Rds')
```
```{r calc_exp_cl,echo=verbose,cache=TRUE}
#out <- iseqr_exp_cl(ds_nt,dict)
#source('~/Documents/emj/ImmunoseqResults/immunoSeqR/scripts/exp_cl.R')
```
```{r exp_cl_plot, echo=verbose,fig.align='center',fig.height=3,fig.width=2}
...
g
```
```{r exp_cl_vs_Tumor, echo=verbose}
mats <- out$total
patients <- names(mats)
